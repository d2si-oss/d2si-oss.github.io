...
## Introduction
<p align="center">
  <img width="15%" src="/assets/2017-06-26-ooso/library-logo.png"/>
</p>
...
## Ooso's architecture
Before diving into a concrete example of how to use the library, let's take a quick look at the underlying architecture.
Ooso's architecture comprises six lambda functions and three s3 buckets that coordinate to lead a [MapReduce](https://en.wikipedia.org/wiki/MapReduce) job from start to end.
